...
export default [
    ...
    { name: 'refUsersList', path: '/refusers/', component: RefUsersList, meta: {requiresAuth: true, requiresAdmin: true, group: 'refUsersList'} },
    { name: 'refUsersEdit', path: '/refusers/:id', component: RefUserEdit, meta: {requiresAuth: true, requiresAdmin: true, group: 'refUsersList'} },
    ...
    { name: 'usersList', path: '/users/', component: UsersList, meta: {requiresAuth: true, requiresAdmin: true, group: 'usersList'} },
    { name: 'userNew', path: '/users/new', component: UsersEdit, meta: {requiresAuth: true, requiresAdmin: true, group: 'usersList'} },
    { name: 'userEdit', path: '/users/:id', component: UsersEdit, meta: {requiresAuth: true, requiresAdmin: true, group: 'usersList'} },
];
