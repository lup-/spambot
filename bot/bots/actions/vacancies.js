...
module.exports = {
    disclaimer: {text: `Добро пожаловать в бота для поиска вакансий на удалённую работу от канала @BeemBam.
...
Это системное сообщение, оно выводится один раз. Приятного пользования и удачи в поисках!`, tags: ['content', 'vacancies', 'job', 'intro']},
    withPhoto: false,
