...
module.exports = function ({payment}) {
    ...
    scene.enter(async ctx => {
        let text = `Премиум - это удобный и экономный способ получить доступ сразу ко всем материалам бота. 

После его приобретения вы получаете безлимитный доступ к 65 выжимкам по 14 образовательным темам.

Получай навыки для удаленной профессии за 5 дней вместо 5 месяцев за 1% от стоимости оригиналов.`;
