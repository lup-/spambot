...
module.exports = function () {
    ...
    scene.enter(async ctx => {
        ...
        try {
            ...
            return ctx.reply(__(`Привет! Этот бот содержит в себе топ лучших подкастов за всё время. Он поможет найти наиболее релевантные вашим пожеланиям варианты и выдаст аудиофайл для прослушивания из телеграм. 
